...
def parse_arguments():
    ...
    parser.add_argument('--content_dir',type=str,default=r'C:\Users\BHUPATHI NADAR\OneDrive\Desktop\Main_project\NST_project\content_data',
                        help='Location of content dataset')
    
    parser.add_argument('--style_dir',type=str,default=r'C:\Users\BHUPATHI NADAR\OneDrive\Desktop\Main_project\NST_project\style_data',
                        help='Location of content dataset')

    parser.add_argument('--vgg',type=str,default=r'vgg_normalized.pth',
    ...
    parser.add_argument("--decoder_path",type=str,default=None,
                        help='Path to decoder checkpoit')
    
    parser.add_argument("--optimizer_path",type=str,default=None,
                        help='Path to optimizer checkpoit')
...
def main():
    ...
    content_dataloader=DataLoader(content_dataset,batch_size=args.batch_size,
                                  shuffle=True,pin_memory=True,
                                  drop_last=True)
    
    style_dataloader=DataLoader(style_dataset,batch_size=args.batch_size,
                                  shuffle=True,pin_memory=True,
                                  drop_last=True)
